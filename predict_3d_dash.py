...
def predict(model_path, image_dir, image_extension, tile_size, overlap_fraction, channel_zero_index, force_z, model_name=None):
    ...
    Saves an inference.yaml file in the image directory with the original image shape and path. The 
    yaml info is used to merge the tiles without having to open the image again.
...
# EXAMPLE USE
# --------------
# model_path = '/ssd1/rla/cheng-yi/cnidocyte/logs/jay_jeff_emma/1614873611_completed/jay_jeff_emma_e187-l0.00325.h5'
# # model_dir = '/ssd1/rla#/cheng-yi/cnidocyte/logs/jay_jeff_emma/1614873611_completed/' # Only if predicting all models
# image_dir = '/n/projects/jru/public/emma_moore/3PO histology test for jay jeff/RICHARD/TEST/'  # '/n/core/micro/asa/fgm/smc/20190919_Screen/DeepLearn/Training/RICHARD/TEST/'
